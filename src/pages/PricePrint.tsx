...
const prices = [
  ...
  { name: 'Группа выходного дня', type: 'Групповое занятие', price: '6 500 ₽', unit: '8 занятий', emoji: '🎈' },
  { name: 'Мини-сад', type: 'Абонемент', price: '7 500 ₽', unit: '4 посещения по 3 часа, по субботам', emoji: '🧸' },
  { name: 'Мини-сад', type: 'Разовое посещение', price: '2 500 ₽', unit: '1 посещение', emoji: '🧸' },
];
